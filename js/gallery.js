...
// ПЕРЕБИРАЄМО ЗОБРАЖЕННЯ ТА РОБИМО РОЗМІТКУ
...
gallery.addEventListener('click', getDataImg);
function getDataImg(event) {
  // РОБИМО ЩОБ КЛІК БУВ ТІЛЬКИ ПО ІМГ А НЕ В ІНШОМУ МІСЦІ
